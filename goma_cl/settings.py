...
MIDDLEWARE = [
    ...
    'django.middleware.locale.LocaleMiddleware',  # Pour i18n (FR/EN)
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.i18n',  # Pour les langues
            ],
        },
    },
]
...
if DEBUG:
    ...
    # En production (PostgreSQL sur Render)
    DATABASES = {
...
TIME_ZONE = 'Africa/Lubumbashi'  # Fuseau horaire de Goma
